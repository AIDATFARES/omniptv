...
export const metadata: Metadata = {
  title: "Ultimate 4K IPTV Service – 50,000+ Channels & VOD | OmniPtv",
  description: "Unlock endless entertainment with OmniPtv. Stream 50,000+ live TV channels, premium sports, and 120,000+ VODs in true 4K quality across all your favorite devices.",
        ...
        <footer className="w-full mt-auto border-t border-white/10 bg-[#050607]">
          <div className="grid max-w-[1400px] grid-cols-2 gap-x-4 gap-y-12 px-6 py-16 sm:grid-cols-4 sm:gap-x-8 sm:px-10 xl:grid-cols-[1.8fr_1fr_1fr_1fr_1fr] xl:gap-10 xl:px-12 mx-auto">
            <div className="col-span-2 sm:col-span-4 xl:col-span-1 min-w-0 max-w-[310px] space-y-4">
              ...
              <a href="https://wa.me/213552069874" target="_blank" rel="noreferrer" className="flex max-w-[270px] items-center gap-3 rounded-2xl border border-emerald-500/30 bg-emerald-500/[0.08] p-3.5 transition-colors hover:from-[#E83E59] hover:to-[#FF5A2F]/[0.15] group">
